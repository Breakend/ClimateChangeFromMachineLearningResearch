...
\begin{document}%
\normalsize%
\section{Experiment 2 of set Normal Convolutions (64 filters)}%
\label{sec:Experiment 2 of set Normal Convolutions (64 filters)}%
...
\hline%
average gCO2eq/kWh&166.53716148468405\\%
\hline%
...
\begin{tabular}{|r|c|}%
\hline%
Experiment Start Time&1570659879.958729\\%
\hline%
Experiment Length (hours)&0.1400953405433231\\%
\hline%
Intel (CPU+DRAM, RAPL) Power Usage (kWh)&0.0029442194149952475\\%
\hline%
NVIDIA (GPU) Power Usage (kWh)&0.021460725342541277\\%
\hline%
Total (Including PUE Mult.) Power (kWh)&0.038559812716907685\\%
\hline%
Estimated Carbon Impact (kgCO2eq)&0.006421586261049826\\%
\hline%
Final CPU{-}Hours (psutil estimate)&0.155175\\%
\hline%
Final GPU{-}Hours (climate{-}impact{-}tracker estimate)&0.13335212183186299\\%
\hline%
\end{tabular}
