...
\begin{document}%
\normalsize%
\section{Experiment 0 of set Separable Convolutions (512 filters)}%
\label{sec:Experiment 0 of set Separable Convolutions (512 filters)}%
...
\hline%
hz\_actual&2.3574 GHz\\%
\hline%
hz\_advertised\_raw&2400000000, 0\\%
\hline%
hz\_actual\_raw&2357437000, 0\\%
\hline%
stepping&2\\%
\hline%
model&63\\%
...
\hline%
average gCO2eq/kWh&330.2014944715081\\%
\hline%
...
\begin{tabular}{|r|c|}%
\hline%
Experiment Start Time&1570702333.886713\\%
\hline%
Experiment Length (hours)&1.5104079091548919\\%
\hline%
Intel (CPU+DRAM, RAPL) Power Usage (kWh)&0.020721157032276255\\%
\hline%
NVIDIA (GPU) Power Usage (kWh)&0.23069466630031268\\%
\hline%
Total (Including PUE Mult.) Power (kWh)&0.3972370008654905\\%
\hline%
Estimated Carbon Impact (kgCO2eq)&0.12394793847832826\\%
\hline%
Final CPU{-}Hours (psutil estimate)&1.6346916666666662\\%
\hline%
Final GPU{-}Hours (climate{-}impact{-}tracker estimate)&1.4918628010489765\\%
\hline%
\end{tabular}
