...
\begin{document}%
\normalsize%
\section{Experiment 1 of set Separable Convolutions (128 filters)}%
\label{sec:Experiment 1 of set Separable Convolutions (128 filters)}%
...
\hline%
hz\_actual&1.2340 GHz\\%
\hline%
hz\_advertised\_raw&2600000000, 0\\%
\hline%
hz\_actual\_raw&1233984000, 0\\%
\hline%
stepping&2\\%
\hline%
model&63\\%
...
\hline%
average gCO2eq/kWh&153.47674638591144\\%
\hline%
...
\begin{tabular}{|r|c|}%
\hline%
Experiment Start Time&1572213217.641391\\%
\hline%
Experiment Length (hours)&0.8872350319226583\\%
\hline%
Intel (CPU+DRAM, RAPL) Power Usage (kWh)&0.011675562049386436\\%
\hline%
NVIDIA (GPU) Power Usage (kWh)&0.19218572190259298\\%
\hline%
Total (Including PUE Mult.) Power (kWh)&0.3221008286441275\\%
\hline%
Estimated Carbon Impact (kgCO2eq)&0.04944669918762909\\%
\hline%
Final CPU{-}Hours (psutil estimate)&1.0072555555555556\\%
\hline%
Final GPU{-}Hours (climate{-}impact{-}tracker estimate)&0.8435486075064125\\%
\hline%
\end{tabular}
