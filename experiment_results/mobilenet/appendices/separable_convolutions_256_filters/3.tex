...
\begin{document}%
\normalsize%
\section{Experiment 3 of set Separable Convolutions (256 filters)}%
\label{sec:Experiment 3 of set Separable Convolutions (256 filters)}%
...
\hline%
average gCO2eq/kWh&318.9599718600453\\%
\hline%
...
\begin{tabular}{|r|c|}%
\hline%
Experiment Start Time&1570700210.415345\\%
\hline%
Experiment Length (hours)&0.5825133614407645\\%
\hline%
Intel (CPU+DRAM, RAPL) Power Usage (kWh)&0.007891592319040948\\%
\hline%
NVIDIA (GPU) Power Usage (kWh)&0.09124554471340973\\%
\hline%
Total (Including PUE Mult.) Power (kWh)&0.15663667651127208\\%
\hline%
Estimated Carbon Impact (kgCO2eq)&0.04996131615103212\\%
\hline%
Final CPU{-}Hours (psutil estimate)&0.6323138888888888\\%
\hline%
Final GPU{-}Hours (climate{-}impact{-}tracker estimate)&0.5749535223449269\\%
\hline%
\end{tabular}
