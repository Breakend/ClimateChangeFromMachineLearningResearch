...
\begin{document}%
\normalsize%
\section{Experiment 2 of set Normal Convolutions (512 filters)}%
\label{sec:Experiment 2 of set Normal Convolutions (512 filters)}%
...
\hline%
hz\_actual&1.2714 GHz\\%
\hline%
hz\_advertised\_raw&2400000000, 0\\%
\hline%
hz\_actual\_raw&1271437000, 0\\%
\hline%
stepping&2\\%
\hline%
model&63\\%
...
\hline%
average gCO2eq/kWh&219.5748678951902\\%
\hline%
...
\begin{tabular}{|r|c|}%
\hline%
Experiment Start Time&1571075430.904974\\%
\hline%
Experiment Length (hours)&3.9310558497243457\\%
\hline%
Intel (CPU+DRAM, RAPL) Power Usage (kWh)&0.21882661556209929\\%
\hline%
NVIDIA (GPU) Power Usage (kWh)&0.7149544720424871\\%
\hline%
Total (Including PUE Mult.) Power (kWh)&1.4753741184152465\\%
\hline%
Estimated Carbon Impact (kgCO2eq)&0.3239453473250857\\%
\hline%
Final CPU{-}Hours (psutil estimate)&4.278841666666667\\%
\hline%
Final GPU{-}Hours (climate{-}impact{-}tracker estimate)&3.8637262321850767\\%
\hline%
\end{tabular}
