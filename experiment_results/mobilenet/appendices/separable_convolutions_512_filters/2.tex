...
\begin{document}%
\normalsize%
\section{Experiment 2 of set Separable Convolutions (512 filters)}%
\label{sec:Experiment 2 of set Separable Convolutions (512 filters)}%
...
\hline%
average gCO2eq/kWh&337.15411927944996\\%
\hline%
...
\begin{tabular}{|r|c|}%
\hline%
Experiment Start Time&1570713257.053442\\%
\hline%
Experiment Length (hours)&1.5110325202676984\\%
\hline%
Intel (CPU+DRAM, RAPL) Power Usage (kWh)&0.035454624348487104\\%
\hline%
NVIDIA (GPU) Power Usage (kWh)&0.23011517583597635\\%
\hline%
Total (Including PUE Mult.) Power (kWh)&0.41960028429145224\\%
\hline%
Estimated Carbon Impact (kgCO2eq)&0.14146981822434992\\%
\hline%
Final CPU{-}Hours (psutil estimate)&1.6456527777777779\\%
\hline%
Final GPU{-}Hours (climate{-}impact{-}tracker estimate)&1.4934131129657118\\%
\hline%
\end{tabular}
