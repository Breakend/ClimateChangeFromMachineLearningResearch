...
\begin{document}%
\normalsize%
\section{Experiment 3 of set Separable Convolutions (64 filters)}%
\label{sec:Experiment 3 of set Separable Convolutions (64 filters)}%
...
\hline%
average gCO2eq/kWh&293.6711662413824\\%
\hline%
...
\begin{tabular}{|r|c|}%
\hline%
Experiment Start Time&1570686359.415164\\%
\hline%
Experiment Length (hours)&0.11356489638487498\\%
\hline%
Intel (CPU+DRAM, RAPL) Power Usage (kWh)&0.0012843111178416477\\%
\hline%
NVIDIA (GPU) Power Usage (kWh)&0.01694888847408891\\%
\hline%
Total (Including PUE Mult.) Power (kWh)&0.028808455355250277\\%
\hline%
Estimated Carbon Impact (kgCO2eq)&0.00845891651046914\\%
\hline%
Final CPU{-}Hours (psutil estimate)&0.12546944444444444\\%
\hline%
Final GPU{-}Hours (climate{-}impact{-}tracker estimate)&0.11034730823205573\\%
\hline%
\end{tabular}
