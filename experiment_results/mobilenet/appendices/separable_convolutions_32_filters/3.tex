...
\begin{document}%
\normalsize%
\section{Experiment 3 of set Separable Convolutions (32 filters)}%
\label{sec:Experiment 3 of set Separable Convolutions (32 filters)}%
...
\hline%
average gCO2eq/kWh&309.44588427466465\\%
\hline%
...
\begin{tabular}{|r|c|}%
\hline%
Experiment Start Time&1570684460.836046\\%
\hline%
Experiment Length (hours)&0.08558634890450371\\%
\hline%
Intel (CPU+DRAM, RAPL) Power Usage (kWh)&0.0008475604376662247\\%
\hline%
NVIDIA (GPU) Power Usage (kWh)&0.007392104324066264\\%
\hline%
Total (Including PUE Mult.) Power (kWh)&0.013018670323537332\\%
\hline%
Estimated Carbon Impact (kgCO2eq)&0.004028803922188148\\%
\hline%
Final CPU{-}Hours (psutil estimate)&0.09505\\%
\hline%
Final GPU{-}Hours (climate{-}impact{-}tracker estimate)&0.050537254262699026\\%
\hline%
\end{tabular}
