...
\begin{document}%
\normalsize%
\section{Experiment 1 of set Separable Convolutions (256 filters)}%
\label{sec:Experiment 1 of set Separable Convolutions (256 filters)}%
...
\hline%
hz\_actual&1.2961 GHz\\%
\hline%
hz\_advertised\_raw&2400000000, 0\\%
\hline%
hz\_actual\_raw&1296093000, 0\\%
\hline%
stepping&2\\%
\hline%
model&63\\%
...
\hline%
average gCO2eq/kWh&295.9340333041107\\%
\hline%
...
\begin{tabular}{|r|c|}%
\hline%
Experiment Start Time&1570695959.929699\\%
\hline%
Experiment Length (hours)&0.5818472533093558\\%
\hline%
Intel (CPU+DRAM, RAPL) Power Usage (kWh)&0.023017220392177358\\%
\hline%
NVIDIA (GPU) Power Usage (kWh)&0.09086607878183589\\%
\hline%
Total (Including PUE Mult.) Power (kWh)&0.179935612694941\\%
\hline%
Estimated Carbon Impact (kgCO2eq)&0.05322621884416462\\%
\hline%
Final CPU{-}Hours (psutil estimate)&0.6370444444444445\\%
\hline%
Final GPU{-}Hours (climate{-}impact{-}tracker estimate)&0.5747316679077015\\%
\hline%
\end{tabular}
