...
\begin{document}%
\normalsize%
\section{Experiment 0 of set Normal Convolutions (256 filters)}%
\label{sec:Experiment 0 of set Normal Convolutions (256 filters)}%
...
\hline%
hz\_actual&1.5849 GHz\\%
\hline%
hz\_advertised\_raw&2400000000, 0\\%
\hline%
hz\_actual\_raw&1584937000, 0\\%
\hline%
stepping&2\\%
\hline%
model&63\\%
...
\hline%
average gCO2eq/kWh&334.59361188332997\\%
\hline%
...
\begin{tabular}{|r|c|}%
\hline%
Experiment Start Time&1570670296.632802\\%
\hline%
Experiment Length (hours)&0.8885586019357046\\%
\hline%
Intel (CPU+DRAM, RAPL) Power Usage (kWh)&0.01944959447712901\\%
\hline%
NVIDIA (GPU) Power Usage (kWh)&0.1443912713811146\\%
\hline%
Total (Including PUE Mult.) Power (kWh)&0.25886856805602493\\%
\hline%
Estimated Carbon Impact (kgCO2eq)&0.08661200901249087\\%
\hline%
Final CPU{-}Hours (psutil estimate)&0.9691722222222223\\%
\hline%
Final GPU{-}Hours (climate{-}impact{-}tracker estimate)&0.8707842642238406\\%
\hline%
\end{tabular}
