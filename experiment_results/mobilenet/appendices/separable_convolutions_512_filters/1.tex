...
\begin{document}%
\normalsize%
\section{Experiment 1 of set Separable Convolutions (512 filters)}%
\label{sec:Experiment 1 of set Separable Convolutions (512 filters)}%
...
\hline%
hz\_actual&1.8966 GHz\\%
\hline%
hz\_advertised\_raw&2400000000, 0\\%
\hline%
hz\_actual\_raw&1896562000, 0\\%
\hline%
stepping&2\\%
\hline%
model&63\\%
...
\hline%
average gCO2eq/kWh&335.00624023729677\\%
\hline%
...
\begin{tabular}{|r|c|}%
\hline%
Experiment Start Time&1570707795.208678\\%
\hline%
Experiment Length (hours)&1.5106693927447001\\%
\hline%
Intel (CPU+DRAM, RAPL) Power Usage (kWh)&0.032619784228199805\\%
\hline%
NVIDIA (GPU) Power Usage (kWh)&0.2297927089742687\\%
\hline%
Total (Including PUE Mult.) Power (kWh)&0.41461173925990025\\%
\hline%
Estimated Carbon Impact (kgCO2eq)&0.13890315069721645\\%
\hline%
Final CPU{-}Hours (psutil estimate)&1.643275\\%
\hline%
Final GPU{-}Hours (climate{-}impact{-}tracker estimate)&1.4927921038394616\\%
\hline%
\end{tabular}
